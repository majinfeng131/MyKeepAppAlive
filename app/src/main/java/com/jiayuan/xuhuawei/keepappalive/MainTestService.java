 ...
 */
public class MainTestService extends Service implements Runnable {
    ...
    private static final long INTERVAL_MAX_COMM_TIME = 40;//每隔一段时间 启动app 重置状态
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if(what==TYPE_JUMP_WIFI){
                AppUtils.jump2WifiSetting(MainTestService.this);
